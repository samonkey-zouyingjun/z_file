...
public class Name {
    ...
    int writeWireFormat(byte[] dst, int dstIndex) {
        ...
        return writeScopeWireFormat(dst, dstIndex + 33) + 33;
    }
    ...
    int readWireFormat(byte[] src, int srcIndex) {
        ...
        this.hexCode = ((src[srcIndex + 31] & 255) - 65) << 4;
        this.hexCode |= ((src[(srcIndex + 31) + 1] & 255) - 65) & 15;
        return readScopeWireFormat(src, srcIndex + 33) + 33;
    }
