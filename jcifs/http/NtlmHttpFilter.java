...
public class NtlmHttpFilter implements Filter {
    ...
    L_0x0082:
        jcifs.smb.SmbSession.logon(r5, r9);	 Catch:{ SmbAuthException -> 0x012b }
        r15 = log;	 Catch:{ SmbAuthException -> 0x012b }
        r15 = jcifs.util.LogStream.level;	 Catch:{ SmbAuthException -> 0x012b }
        r16 = 2;
        r0 = r16;
        if (r15 <= r0) goto L_0x00b7;
    L_0x008f:
        r15 = log;	 Catch:{ SmbAuthException -> 0x012b }
        r16 = new java.lang.StringBuilder;	 Catch:{ SmbAuthException -> 0x012b }
        r16.<init>();	 Catch:{ SmbAuthException -> 0x012b }
        r17 = "NtlmHttpFilter: ";
        r16 = r16.append(r17);	 Catch:{ SmbAuthException -> 0x012b }
        r0 = r16;
        r16 = r0.append(r9);	 Catch:{ SmbAuthException -> 0x012b }
        r17 = " successfully authenticated against ";
        r16 = r16.append(r17);	 Catch:{ SmbAuthException -> 0x012b }
        r0 = r16;
        r16 = r0.append(r5);	 Catch:{ SmbAuthException -> 0x012b }
        r16 = r16.toString();	 Catch:{ SmbAuthException -> 0x012b }
        r15.println(r16);	 Catch:{ SmbAuthException -> 0x012b }
    L_0x00b7:
        r15 = r20.getSession();
        r16 = "NtlmHttpAuth";
        r0 = r16;
    ...
    L_0x00ef:
        ...
        r7 = r14.indexOf(r15);
        r15 = -1;
        if (r7 != r15) goto L_0x00fe;
    L_0x00f8:
        r15 = 47;
        r7 = r14.indexOf(r15);
    L_0x00fe:
        r15 = -1;
        if (r7 == r15) goto L_0x0126;
    L_0x0101:
        r15 = 0;
        r6 = r14.substring(r15, r7);
    L_0x0106:
        r15 = -1;
        if (r7 == r15) goto L_0x010f;
    L_0x0109:
        r15 = r7 + 1;
