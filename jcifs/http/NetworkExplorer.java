...
public class NetworkExplorer extends HttpServlet {
    ...
    protected void doFile(HttpServletRequest req, HttpServletResponse resp, SmbFile file) throws IOException {
        ...
        resp.setHeader(HTTP.CONTENT_LENGTH, file.length() + "");
    ...
    protected void doDirectory(HttpServletRequest req, HttpServletResponse resp, SmbFile dir) throws IOException {
        ...
        int sort = 0;
        String str = req.getParameter(AppConstant.PREFEREANCES_SORT);
        ...
        while (iter.hasNext()) {
            ...
            if (fmt.equals("detail")) {
                ...
                if (f.isDirectory()) {
                    ...
                    out.print((f.length() / PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) + " KB </div><div>");
                ...
                if (f.isDirectory()) {
                    ...
                    out.print((f.length() / PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) + "KB <br>");
                    out.print(simpleDateFormat.format(new Date(f.lastModified())));
                    out.print("</small>");
                    out.println("</a>");
                }
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        if (msg != null && (msg.startsWith("NTLM ") || (offerBasic && msg.startsWith("Basic ")))) {
            ...
            String user;
            String auth = new String(Base64.decode(msg.substring(6)), e.b);
            ...
            if (ntlm == null) {
                ...
                resp.setHeader(HTTP.CONNECTION, HTTP.CLOSE);
                resp.setStatus(401);
                resp.flushBuffer();
                return;
            }
