...
class XPathVisitor implements Visitor {
    ...
    public void visit(AttrExistsExpr attrExistsExpr) throws XPathException {
        if (this.node_ instanceof Element) {
            ...
            Object obj = (attribute == null || attribute.length() <= 0) ? null : 1;
            this.exprStack_.push(obj != null ? TRUE : FALSE);
            return;
        }
        throw new XPathException(this.xpath_, "Cannot test attribute of document");
    }
    ...
    public void visit(AttrGreaterExpr attrGreaterExpr) throws XPathException {
        if (this.node_ instanceof Element) {
            this.exprStack_.push(((((double) Long.parseLong(((Element) this.node_).getAttribute(attrGreaterExpr.getAttrName()))) > attrGreaterExpr.getAttrValue() ? 1 : (((double) Long.parseLong(((Element) this.node_).getAttribute(attrGreaterExpr.getAttrName()))) == attrGreaterExpr.getAttrValue() ? 0 : -1)) > 0 ? 1 : null) != null ? TRUE : FALSE);
            return;
        }
        throw new XPathException(this.xpath_, "Cannot test attribute of document");
    }
    ...
    public void visit(AttrLessExpr attrLessExpr) throws XPathException {
        if (this.node_ instanceof Element) {
            this.exprStack_.push(((((double) Long.parseLong(((Element) this.node_).getAttribute(attrLessExpr.getAttrName()))) > attrLessExpr.getAttrValue() ? 1 : (((double) Long.parseLong(((Element) this.node_).getAttribute(attrLessExpr.getAttrName()))) == attrLessExpr.getAttrValue() ? 0 : -1)) < 0 ? 1 : null) != null ? TRUE : FALSE);
            return;
        }
        throw new XPathException(this.xpath_, "Cannot test attribute of document");
    }
    ...
    public void visit(AttrNotEqualsExpr attrNotEqualsExpr) throws XPathException {
        if (this.node_ instanceof Element) {
            this.exprStack_.push((!attrNotEqualsExpr.getAttrValue().equals(((Element) this.node_).getAttribute(attrNotEqualsExpr.getAttrName())) ? 1 : null) != null ? TRUE : FALSE);
            return;
        }
        throw new XPathException(this.xpath_, "Cannot test attribute of document");
    }
    ...
    public void visit(AttrTest attrTest) {
        ...
        while (elements.hasMoreElements()) {
            ...
            if (node instanceof Element) {
                String attribute = ((Element) node).getAttribute(attrTest.getAttrName());
                if (attribute != null) {
    ...
    public void visit(PositionEqualsExpr positionEqualsExpr) throws XPathException {
        if (this.node_ instanceof Element) {
            this.exprStack_.push((this.nodelistRaw_.position((Element) this.node_) == positionEqualsExpr.getPosition() ? 1 : null) != null ? TRUE : FALSE);
            return;
        }
