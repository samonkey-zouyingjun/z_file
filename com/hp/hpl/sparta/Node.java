...
public abstract class Node {
    ...
    class AnonymousClass1 implements BooleanExprVisitor {
        ...
        AnonymousClass1(Node node, Element element, Element element2, String str, String str2) throws XPathException {
            this.this$0 = node;
    ...
    Element makeMatching(Element element, Step step, String str) throws ParseException, XPathException {
        ...
        if (nodeTest instanceof ElementTest) {
            ...
            step.getPredicate().accept(new AnonymousClass1(this, element2, element, str, tagName));
            return element2;
        }
